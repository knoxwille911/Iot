...
-(void) keyboardWillShow:(NSNotification *)note{
    ...
    containerFrame.origin.y = _targetViewController.view.bounds.size.height - (keyboardBounds.size.height + containerFrame.size.height) + [self.delegate tabbarHeight];
    // animations settings
